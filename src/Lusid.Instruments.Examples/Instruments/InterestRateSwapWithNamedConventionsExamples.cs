...
namespace Lusid.Instruments.Examples.Instruments
{
    ...
    public class InterestRateSwapWithNamedConventions: DemoInstrumentBase
    {
        ...
        /// <inheritdoc />
        protected override void CreateAndUpsertMarketDataToLusid(string scope, ModelSelection.ModelEnum model, LusidInstrument instrument, ModelOptions? modelOptions=null)
        {
